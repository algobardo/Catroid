...
public class StageActivityAudioFocusTest extends ActivityUnitTestCase<StageActivity> {

	public StageActivityAudioFocusTest() {
		super(StageActivity.class);
	}

	private static final String TAG = StageActivityAudioFocusTest.class.getSimpleName();
